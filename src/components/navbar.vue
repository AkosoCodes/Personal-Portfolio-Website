<template>
  ...
  <div id="navbar">
    <div class=" flex flex-row justify-end sticky opacity-90 t-0 w-full h-80px border-solid border-b-[3px] border-accent border-opacity-50  bg-main-dark z-50">
      <ul id="navbar" class="nav-sm:hidden flex flex-row justify-end sticky t-0 opacity-90  w-full h-80px border-solid border-b-[3px] border-accent border-opacity-50  bg-main-dark z-50">

      <li class="my-auto mx-1 p-5 text-main hover:text-accent bg-inherit"><a href="" class="bg-inherit"><span
            class="text-accent bg-inherit">01. </span>About</a></li>
      <li class="my-auto mx-1 p-5 text-main hover:text-accent bg-inherit"><a href="" class="bg-inherit"><span
            class="text-accent bg-inherit">02. </span>Projects</a></li>
      <li class="my-auto mx-1 p-5 text-main hover:text-accent bg-inherit">
        <a href="" class="bg-inherit">
          <span
            class="text-accent bg-inherit">03. 
          </span>Contact
        </a>
      </li>
      ...
      <li class="my-auto mx-1 mr-[20px] p-5 text-main hover:text-accent bg-inherit">
        <form method="get" action="src/assets/files/resume.pdf">
          <button class="text-accent bg-accent bg-opacity-25 rounded-md px-5 py-1 border-accent border-[2px] hover:scale-105 hover:bg-opacity-0" type="submit">Resume</button>
        </form>
      </li>
    </ul>
      ...
      <button v-on:click="toggleHidden()" class="nav-sm:visible md:hidden bg-inherit justify-end m-10px mr-[15px]">
        ...
        <svg v-if="!showClose" class="bg-inherit fill-main hover:fill-accent" xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 30 30" width="50px" height="50px">
          <path
    ...
    <!-- Hidden Nav -->
    <ul v-if="showHiddenDiv" class="flex flex-col h-full w-[70%] justify-center mx-auto text-base bg-inherit">
      <li class="w-[145px] mx-auto py-2 mt-[20px] text-main  bg-inherit">
      ...
      <li class="w-[145px] mx-auto py-5 text-main hover:text-accent bg-inherit"><a href=""
          class="flex flex-col  mx-auto bg-inherit"><span class="text-accent mx-auto bg-inherit">02. </span><span
            class="text-main bg-inherit mx-auto hover:text-accent">Projects</span></a></li>
      <li class="w-[145px] mx-auto py-2 text-main hover:text-accent bg-inherit"><a href=""
          class="flex flex-col  mx-auto bg-inherit"><span class="text-accent mx-auto bg-inherit">03. </span><span
            class="text-main bg-inherit mx-auto hover:text-accent">Contact</span></a></li>
